...
std::string cert=help;   
std::cout<<cert<<std::endl;

    char *filename2="localhost.decrypted.key";
    int N2;
	...
	N2=N2-input2.tellg();
	char* data2= new char[N2];
	input2.read(data2,N2);
	std::string help2(data2,N2);
	delete[] data2;
/*
    std::string key =
        "-----BEGIN PRIVATE KEY-----\n"
